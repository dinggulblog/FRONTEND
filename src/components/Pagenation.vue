<template>
  <div class="page" :style="{ gridTemplateColumns: `auto 800px auto` }">
    ...
    <button
      class="prev-btn"
      @click="onPrevPage"
      :style="page - skip < 1 ? { color: 'var(--sub)' } : { color: 'var(--point)' }"
    >
    ...
    <div class="pages">
      <div class="page-btns">
        <button
          ...
          :style="
            p === page
              ? { color: 'var(--point)', fontWeight: 'bold', borderBottom: '2px solid', borderColor: 'var(--point)' }
              : { color: 'var(--sub)' }
          "
    ...
    <button
      class="next-btn"
      @click="onNextPage"
      :style="maxPage < (pageStart + 1) * skip + 1 ? { color: 'var(--sub)' } : { color: 'var(--point)' }"
    >
      <span>NEXT</span>
